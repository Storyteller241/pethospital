<template>
  ...
  <div style="padding-bottom: 5px;">
   ...
   <el-row>
     <el-col :span="24">
       <div style="padding-left: 900px;"><el-button round  icon="el-icon-circle-plus-outline" type="primary" @click="addUser" style="background: sandybrown; border-color:sandybrown ;"><span style="margin-left: 5px;">新增医生</span></el-button></div>
   </el-col>
   </el-row>
 </el-card>
  </div>
  <el-card shadow="hover" class="describe-container" body-style="">
    <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="age" label="医生年龄" width="120">
          </el-table-column>
          <el-table-column prop="lic" label="医生执照" width="120">
          </el-table-column>
          <el-table-column prop="cons" label="诊室" width="120">
          </el-table-column>
 ...
 <el-dialog class="el-icon-sugar" title="🐱编辑医生信息🐶" :visible.sync="dialogFormVisible">
   <el-form :model="form">
     ...
     <el-form-item label="🐕医生诊室" :label-width="formLabelWidth">
     ...
     <el-form-item label="医生执照  " :label-width="formLabelWidth">
       <el-input v-model="form.lic" autocomplete="off" clearable></el-input>
     </el-form-item> 
   </el-form>
 ...
 <el-dialog class="el-icon-sugar" title="🐱添加医生信息🐶" :visible.sync="dialogFormVisible1">
   <el-form :model="form1">
     <el-form-item label="姓名" :label-width="formLabelWidth">
     ...
     <el-form-item label="执照" :label-width="formLabelWidth">
       <el-input v-model="form1.lic" autocomplete="off" clearable></el-input>
     </el-form-item>
   </el-form>
   <div slot="footer" class="dialog-footer">
     ...
     this.$api.add2({
       ...
       delUser(index, row) {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
         ...
         //确定删除
         this.$api.del2({ id: row.id }).then(res => {
           if (res.data.status === 200) {
             this.$message({
               type: 'success',
               message: '删除成功!'
